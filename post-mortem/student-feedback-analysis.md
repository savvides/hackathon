...
| **+38** Net Promoter Score | **8.25** Mean Recommend (0--10) | **4.39** Mean Across All Likerts | **57%** Response Rate (16/28) |
| --- | --- | --- | --- |
...
| Highly effective | ----------------------------- ----------------------------- | **9 (56 %)** |
| --- | --- | --- |
| Functional with friction | ----------------------------- ----------------------------- | **3 (19 %)** |
| Struggled | ----------------------------- ----------------------------- | **3 (19 %)** |
| Mixed contribution | ----------------------------- ----------------------------- | **1 (6 %)** |
...
| Keep pre-assigned (no change) | ----------------------------- ----------------------------- | **6 (38 %)** |
| --- | --- | --- |
| Better skills/interest matching | ----------------------------- ----------------------------- | **6 (38 %)** |
| Allow self-selection | ----------------------------- ----------------------------- | **3 (19 %)** |
| Smaller teams (2--3) | ----------------------------- ----------------------------- | **1 (6 %)** |
...
| Significantly shaped approach | ----------------------------- ----------------------------- | **8 (50 %)** |
| --- | --- | --- |
| Moderately influenced thinking | ----------------------------- ----------------------------- | **5 (31 %)** |
| Felt like a checkbox | ----------------------------- ----------------------------- | **3 (19 %)** |
